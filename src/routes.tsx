...
const appMethods: IMethodComponent[] = [
    ...
    },
    {
        ...
        icon: IconCoin,
        element: createElement(lazy(() => import('./methods/MonetizationList.tsx'))),
        categories: [MethodCategory.CHANNELS, MethodCategory.ACCOUNT],
        authType: AuthType.TG
    },
    {
        id: 'boost_levels',
        icon: IconBolt,
        element: createElement(lazy(() => import('./methods/BoostLevels.tsx'))),
        categories: [MethodCategory.CHANNELS, MethodCategory.CHATS],
        authType: AuthType.TG
    }
];
